...
@section('content')
    ...
    <table class="table-auto w-full mt-1 overscroll-x-auto border-[1px] border-black mb-10">
        <thead>
            <tr>
                <th class="py-2 px-2 border-b-[1px] text-sm border-b-gray-800 font-semibold text-gray-700">
                    Id
                </th>
                <th class="py-2 px-2 border-b-[1px] text-sm border-b-gray-800 font-semibold text-gray-700">
                    Username
                </th>
                <th class="py-2 border-b-[1px] text-sm border-b-gray-800 font-semibold text-gray-700">
                    Email
                </th>
                <th class="py-2 border-b-[1px] text-sm border-b-gray-800 font-semibold text-gray-700">
                    Password
